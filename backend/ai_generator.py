    ...
    def detect_loop(self, tool_name: str, parameters: Dict[str, Any]) -> bool:
        ...
        for record in recent_calls:
            if (
                ...
                and self._calculate_parameter_similarity(record.parameters, parameters)
...
"""
    ...
    def __init__(self, api_key: str, model: str, max_tool_rounds: int = 2):
        ...
        self.base_params = {"model": self.model, "temperature": 0, "max_tokens": 1000}
    ...
    def _build_dynamic_system_prompt(
        ...
        if round_type == ConversationRound.FIRST_ROUND:
            prompt += self.FIRST_ROUND_PROMPT_ADDITION.format(
    ...
    def generate_response(
        ...
        return self._handle_sequential_tool_rounds(
    ...
    def _generate_simple_response(
        ...
        system_content = self._build_dynamic_system_prompt(
            conversation_history, ConversationRound.FIRST_ROUND, 0, ""
        )
    ...
    def _handle_sequential_tool_rounds(
        ...
        while self.sequential_processor.should_continue_rounds():
            ...
            remaining_rounds = (
                self.max_tool_rounds - self.sequential_processor.current_round
            )
            ...
            try:
                ...
                if response.stop_reason == "tool_use":
                    tool_results = self._execute_tools_with_loop_detection(
    ...
    def _execute_tools_with_loop_detection(
        ...
        for content_block in response.content:
            if content_block.type == "tool_use":
                ...
                if self.sequential_processor.detect_loop(
                ...
                self.sequential_processor.add_tool_call_record(
                    content_block.name, content_block.input
                )
    ...
    def _make_final_synthesis_call(
        self, messages: List[Dict[str, Any]], conversation_history: Optional[str]
    ) -> str:
