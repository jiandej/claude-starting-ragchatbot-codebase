...
class TestSequentialToolCalling:
    ...
    def test_loop_detection_behavior(self, mock_anthropic_class):
        ...
        mock_client.messages.create.side_effect = [
            same_search_response1,
            same_search_response2,
        ]
    ...
    def test_max_rounds_termination(self, mock_anthropic_class):
        ...
        final_content = Mock()
        final_content.text = (
            "Based on the searches performed, here's what I found about the courses."
        )
        final_response.content = [final_content]
    ...
    def test_conversation_history_preservation(self):
        ...
        with patch("ai_generator.anthropic.Anthropic") as mock_anthropic_class:
            ...
            result = generator.generate_response(
                "Tell me more about it", conversation_history=history
            )
...
class TestSequentialToolProcessor:
    ...
    def test_loop_detection_basic(self):
        ...
        assert not processor.detect_loop(
    ...
    def test_gathered_info_tracking(self):
        ...
        outline_results = [
            {"content": "Course outline for Python Programming with 5 lessons"}
        ]
        ...
        search_results = [
            {"content": "Lesson 2 content about variables in Python programming"}
        ]
