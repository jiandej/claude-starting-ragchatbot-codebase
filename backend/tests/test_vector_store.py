...
class TestVectorStore:
    ...
    @patch('vector_store.chromadb')
    def test_add_course_content(self, mock_chromadb, sample_course_chunks, temp_chroma_db):
        ...
        # Verify IDs format
        expected_ids = [f"{chunk.course_title.replace(' ', '_')}_{chunk.chunk_index}" for chunk in sample_course_chunks]
    ...
    def test_search_with_course_filter(self, mock_chromadb, temp_chroma_db):
        ...
        mock_collections['course_content'].query.return_value = {
            ...
            'metadatas': [[{'course_title': 'Python Programming Fundamentals', 'lesson_number': 2}]],
            'distances': [[0.15]]
        }
    ...
    def test_search_with_both_filters(self, mock_chromadb, temp_chroma_db):
        ...
        mock_collections['course_content'].query.return_value = {
            ...
            'metadatas': [[{'course_title': 'Advanced Python Programming', 'lesson_number': 2}]],
            'distances': [[0.1]]
        }
    ...
    def test_get_lesson_link(self, mock_chromadb, temp_chroma_db):
        ...
        lessons_data = [
            ...
            {"lesson_number": 2, "lesson_title": "Variables", "lesson_link": "http://example.com/lesson2"}
        ]
