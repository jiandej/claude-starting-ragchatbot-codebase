...
class TestRAGSystemIntegration:
    ...
    def test_rag_system_initialization(
        self, mock_vector_store, mock_ai_generator, test_rag_config
    ):
    ...
    def test_query_without_session(
        self, mock_vector_store_class, mock_ai_generator_class, test_rag_config
    ):
    ...
    def test_query_with_real_ai_generator_mock(
...
class TestFastAPIIntegration:
    ...
    def test_query_endpoint_success(self, mock_rag_system, test_app):
        ...
        response = test_app.post("/api/query", json={"query": "What is Python?"})
    ...
    def test_query_endpoint_with_session(self, mock_rag_system, test_app):
        ...
        mock_rag_system.query.return_value = ("Variables store data.", [])
        ...
        mock_rag_system.query.assert_called_once_with(
            "What are variables?", "existing_session"
        )
...
class TestEndToEndFlow:
    ...
    def test_complete_query_flow_with_mocks(
        self, mock_anthropic_class, mock_chromadb, test_config
    ):
    ...
    def test_session_manager_integration(self, test_config):
        ...
        session_manager.add_exchange(
            session_id, "Is it easy to learn?", "Yes, Python is beginner-friendly."
        )
        ...
        # Test history limit
        session_manager.add_exchange(
            session_id, "What about libraries?", "Python has many libraries."
        )
